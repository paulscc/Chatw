...
-- 3. Auto-crear perfil desde Supabase Auth (NO APLICABLE - PostgreSQL estándar)
-- Esta sección se ha eliminado porque no usa Supabase Auth

-- ─────────────────────────────────────────
-- ROW LEVEL SECURITY (RLS) - EJEMPLOS CLAVE
-- ─────────────────────────────────────────
-- RLS deshabilitado para PostgreSQL estándar
-- Habilitar si se implementa autenticación personalizada