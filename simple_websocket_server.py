#!/usr/bin/env python3
"""
Servidor WebSocket ultra-simple para pruebas
"""
...
async def handle_connection(websocket, path):
    """
    Manejar conexiones WebSocket con la firma correcta
    """
    try:
        logger.info(f"Nueva conexión WebSocket en path: {path}")
        ...
        room_code = parts[1]
        logger.info(f"Cliente conectado a sala: {room_code}")
...
async def main():
    ...
    logger.info("Endpoint: ws://127.0.0.1:8085/ws/{room_code}")
    
    # Usar la sintaxis correcta para websockets.serve
